...
class EmailSender:
    ...
    def createNewMail(self, workBook_path):
        ...
        html_body = """
                <html>
                  ...
                  <body>
                    ...
                    <p>Merhaba arkadaşlar,<br>
                       RMLS tarihi gelen iş yüklerini bugün tamamlamanız ricasıyla, iyi çalışmalar dilerim.<br>
                       
                        <div>image_source(graphic) <img src{}></img> </div>
                        <p><u><b>ANALİZ:</b></u></p>
                        <p><ol></p>
                        <li> KW%(cw_early)i ve KW%(cw_today)i genel olarak çalışma kapasitemize uygun çalışılmıştır.</li>
                        <li> Şu an iş yükünde “ ” Fehler, “ “ Açık Kapsam,  “ “ RMLS,  “ “ AKT ve  “ “ Bildiri bulunmaktadır.</li></ol>
                        
                        <div>image_source(pivot_table)" <img src{}></img>" </div>
                        <b><p>ÖNEMLİ : </p></b>
                        
                        <b>“Açık Kapsam: Kontrol Edilecek”</b> sütununda <b>47’den dönen, geçmiş tarihli, satış nachtragı</b> ya da başka herhangi 
                        sebepten açılan kapsamlar olabilir. Ekteki excel dokümanında “Sheet1” isimli sayfada, 
                        “<b>Çalışma Tipi</b>” sütununda “<b>Kontrol Edilecek</b>” olarak belirtilen çalışmaları kontrol etmenizi rica ederim.
                ...
                """ % {"cw_early": int(calendar_week) - 1, "cw_today": int(calendar_week)}
